...
schtasks /Create /F /RU SYSTEM /TN OnstartConfiguration /SC ONSTART /TR "aria2c.exe %OnstartConfigurationURL% --allow-overwrite=true && OnstartConfiguration.bat" >> %LOG%
